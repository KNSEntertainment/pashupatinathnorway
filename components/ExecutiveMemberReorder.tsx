      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Drag and drop to reorder executive members by hierarchy. Lower numbers appear first.
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="bg-brand_primary hover:bg-brand_primary/90 text-gray-700"
          >
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="w-8 h-8 bg-brand_primary/10 rounded-full flex items-center justify-center text-brand_primary font-semibold text-sm">
                        {index + 1}
                      </div>
                    </div>
