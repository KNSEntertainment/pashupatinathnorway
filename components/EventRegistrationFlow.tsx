          ...
          {userMembership?.membershipStatus === "approved" ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-2 sm:p-4">
              ...
              <button
                ...
                className="w-full bg-green-500 text-white py-2 sm:py-3 rounded-lg hover:bg-green-600 transition-colors text-xs sm:text-base"
              >
                Continue as Member
              </button>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-2 sm:p-4">
              <div className="flex items-start sm:items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="font-semibold text-yellow-800 text-xs sm:text-base">Membership Under Review</h3>
                  <p className="text-yellow-600 text-xs sm:text-sm mt-1">Your membership is currently under review. You can continue as guest.</p>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <button
                  ...
                  className="flex-1 bg-yellow-500 text-white py-2 sm:py-3 rounded-lg hover:bg-yellow-600 transition-colors text-xs sm:text-base"
                >
                  Continue as Guest
                </button>
                <button
                  onClick={() => window.location.href = "/en/membership-status"}
                  className="flex-1 bg-gray-500 text-white py-2 sm:py-3 rounded-lg hover:bg-gray-600 transition-colors text-xs sm:text-base"
                >
        ...
        <div className="space-y-2 sm:space-y-4">
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-2 sm:p-4">
            ...
            <button
              ...
              className="w-full bg-purple-500 text-white py-2 sm:py-3 rounded-lg hover:bg-purple-600 transition-colors text-xs sm:text-base"
            >
              Become Member
            </button>
          </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {[50, 100, 250, 500].map(amount => (
                <button
                  ...
                  className="py-2 px-2 sm:px-3 border border-orange-300 rounded-lg hover:bg-orange-100 transition-colors text-xs sm:text-sm"
                >
                  kr{amount}
                </button>
              ))}
        ...
        {registrationData.donationAmount > 0 && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4">
            <p className="text-green-800 text-sm sm:text-base">
              Thank you for your generous donation of kr{registrationData.donationAmount}!
            </p>
          </div>
        )}
      </div>
    ...
    return (
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
              ...
              <span className="font-medium text-sm sm:text-base text-right">{event?.eventdate} at {event?.eventtime}</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-1 text-lg font-bold">
              ...
              <span className={`text-sm sm:text-lg text-right ${
                totalPayment > 0 ? "text-blue-600" : "text-green-600"
              }`}>
                {totalPayment > 0 ? `kr${totalPayment}` : "FREE"}
              </span>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed text-sm sm:text-base"
        >
  ...
  return (
    <div className="max-w-4xl mx-auto p-2 sm:p-6">
      ...
      {onCancel && (
        <button
          onClick={onCancel}
          className="flex items-center gap-1 sm:gap-2 text-gray-500 hover:text-gray-700 mb-4 sm:mb-6"
        >
        ...
        <div className="mt-2 sm:mt-6 pt-2 sm:pt-6 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-6">
            <div>
              ...
              <span className="ml-2 font-bold text-green-600 text-xs sm:text-base">
                {event.memberPrice > 0 ? `kr${event.memberPrice}` : "FREE"}
              </span>
            </div>
            {event.allowGuestRegistration && (
              <div>
                <span className="text-xs text-gray-500">Guest Price:</span>
                <span className="ml-2 font-bold text-blue-600 text-xs sm:text-base">
                  {event.guestPrice > 0 ? `kr${event.guestPrice}` : "FREE"}
                </span>
              </div>
            )}
      ...
      <div className="bg-white rounded-lg shadow p-2 sm:p-6 border border-gray-200">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-2 sm:gap-4 mt-3 sm:mt-8">
          <button
            ...
            className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed text-xs sm:text-base"
          >
            <ArrowLeft size={16} className="sm:w-5 sm:h-5" />
            Previous
          </button>
          ...
          {currentStep < 5 && (
            <button
              ...
              className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 text-xs sm:text-base"
            >
              Next
