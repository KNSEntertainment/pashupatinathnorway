...
const categories = [
  "rent", "utilities", "salaries", "marketing", "events", 
  "maintenance", "supplies", "insurance", "taxes", "other", "overall"
];
                ...
                <tr key={budget._id} className="hover:bg-gray-50">
                    ...
                    {budget.eventId ? (
                      <div>
                        <p className="font-medium text-gray-900">
                          {budget.event?.eventname || 'Unknown Event'}
                        </p>
                        <p className="text-sm text-gray-500">
                          {budget.event?.eventdate || 'No Date'}
                        </p>
                      </div>
                    ) : (
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-1 text-xs font-medium rounded ${
                      ...
                      budget.status === 'inactive' ? 'bg-yellow-100 text-yellow-800' :
