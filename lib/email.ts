				...
				<div class="container">
					...
					<div class="content">
						...
						<div style="background: white; border-left: 4px solid #10b981; padding: 20px; margin: 20px 0; border-radius: 5px;">
							<h3 style="margin: 0 0 10px 0; color: #10b981;">Family Members Registered</h3>
