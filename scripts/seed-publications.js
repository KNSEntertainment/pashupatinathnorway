  ...
  try {
    ...
    const samplePublications = [
      ...
      },
      {
        ...
        previewUrl: "/reports/audit-2024-preview.pdf",
        language: "en",
        createdBy: adminUser._id
      },
      {
        ...
        previewUrl: "/reports/financial-2024-ne-preview.pdf",
        language: "ne",
        createdBy: adminUser._id
      },
      {
        ...
        previewUrl: "/reports/financial-2023-preview.pdf",
        language: "en",
        createdBy: adminUser._id
      },
      {
        ...
        previewUrl: "/reports/activity-2024-no-preview.pdf",
        language: "no",
        createdBy: adminUser._id
      }
    ];
