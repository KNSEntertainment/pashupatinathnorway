...
const opportunitiesData = [
	{
		...
		fullDescription: "As a Community Organizer, you'll be at the forefront of building strong local networks of Nepalis in Norway. You'll create meaningful connections, organize impactful events, and ensure Pashupatinath Norway Temple's vision reaches every corner of the Norwegian Nepali community.",
		responsibilities: ["Organize and coordinate local community events, meetups, and cultural programs", "Build and maintain relationships with local Nepali organizations and community leaders", "Recruit new members and volunteers for Pashupatinath Norway Temple", "Represent Pashupatinath Norway Temple values and principles at community gatherings", "Coordinate with the national team on local campaign initiatives", "Create monthly reports on community engagement activities"],
		...
		benefits: ["Leadership development opportunities", "Network with influential community members", "Access to Pashupatinath Norway Temple national events and training", "Certificate of recognition for your service", "Direct impact on community building"],
	...
	},
	{
		...
		icon: "📱",
		color: "bg-brand_primary",
		gradient: "from-purple-400 to-purple-600",
		fullDescription: "Digital Activists are the voice of Pashupatinath Norway Temple in the online world. You'll craft compelling narratives, engage with our community on social media, and help build Pashupatinath Norway Temple's digital presence across platforms. Your creativity and digital savvy will help us reach thousands.",
	...
	},
	{
		...
		shortDescription: "Help shape Pashupatinath Norway Temple's policies and strategic direction",
		icon: "📋",
		color: "bg-indigo-500",
		gradient: "from-indigo-400 to-indigo-600",
		fullDescription: "Policy Contributors are the intellectual backbone of Pashupatinath Norway Temple. You'll research critical issues facing Nepal, contribute to policy discussions, and help develop evidence-based positions on key matters. Your expertise will directly influence Pashupatinath Norway Temple's policy platform.",
	...
	},
	{
		...
		fullDescription: "Fundraising Team members ensure Pashupatinath Norway Temple has the resources to achieve its mission. You'll develop creative fundraising campaigns, build relationships with donors, and organize events that generate support for our cause while engaging the community.",
		...
		benefits: ["Fundraising expertise development", "Network with business leaders", "Event management experience", "Recognition for campaign success", "Direct impact on Pashupatinath Norway Temple's capacity"],
	...
	},
	{
		...
		fullDescription: "Youth Ambassadors are the bridge between Pashupatinath Norway Temple and Nepal's future leaders. You'll engage with young Nepalis in Norway, organize campus activities, and ensure youth voices are heard in party decisions. Your energy will inspire the next generation.",
		responsibilities: ["Organize youth-focused events, workshops, and discussions", "Build networks with student organizations and youth groups", "Recruit young members and volunteers", "Advocate for youth issues within Pashupatinath Norway Temple", "Manage youth social media channels", "Mentor younger members and new volunteers"],
	...
	},
	{
		...
		fullDescription: "Creative Team members bring Pashupatinath Norway Temple's message to life through stunning visuals. You'll design graphics, create videos, and develop creative materials that capture attention and inspire action. Your artistic vision will shape how people see Pashupatinath Norway Temple.",
		responsibilities: ["Design graphics for social media, events, and campaigns", "Create and edit videos for digital platforms", "Develop branding materials and visual guidelines", "Design posters, banners, and promotional materials", "Collaborate with other teams on creative needs", "Maintain Pashupatinath Norway Temple's visual identity consistency"],
			...
			<div className="bg-white border-b border-light">
				<div className="max-w-7xl mx-auto px-4 py-4">
					<div className="flex items-center text-sm text-gray-900">
						<Link href="/" className="hover:text-brand_primary">
							Home
						</Link>
						<svg className="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
						</svg>
						<Link href="/get-involved" className="hover:text-brand_primary">
							Get Involved
						</Link>
						<svg className="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
			...
			<div className="p-8">
					...
					<div className="grid md:grid-cols-2 gap-4">
						{opportunity.benefits.map((benefit: string, idx: number) => (
							<div key={idx} className="flex items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
								<svg className="w-5 h-5 text-brand_primary mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
				...
				<section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 text-white text-center">
					...
					<div className="flex flex-wrap justify-center gap-4">
						<button onClick={() => setShowApplyForm(!showApplyForm)} className="px-8 py-4 bg-white text-brand_primary rounded-full font-bold text-lg hover:bg-brand_primary/10 transition-all transform hover:scale-105 shadow-lg">
							Apply Now
						</button>
						<a href={`mailto:${opportunity.contact}`} className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-full font-bold text-lg hover:bg-white hover:text-brand_primary transition-all transform hover:scale-105">
							Ask Questions
						</a>
					</div>
				</section>
		...
		<div className="space-y-4 sticky top-4">
			<div className="bg-white rounded-2xl shadow-lg p-6">
				<h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
					<svg className="w-6 h-6 mr-2 text-brand_primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl shadow-lg p-6 text-white">
				...
				<Link href="/contact" className="block w-full bg-white text-brand_primary text-center py-3 rounded-lg font-semibold hover:bg-brand_primary/10 transition-colors">
					Contact Us
				</Link>
			</div>
		</div>
		...
		<div onClick={onClick} className="group cursor-pointer p-4 rounded-xl border-2 border-light hover:border-blue-500 hover:shadow-lg transition-all bg-white">
			<div className="flex items-start">
				...
				<div className="ml-3 flex-1">
					<h4 className="font-bold text-gray-900 group-hover:text-brand_primary transition-colors mb-1">{opportunity.title}</h4>
					<p className="text-sm text-gray-900 line-clamp-2">{opportunity.shortDescription}</p>
				</div>
				<svg className="w-5 h-5 text-gray-900 group-hover:text-brand_primary group-hover:translate-x-1 transition-all ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
				</svg>
			</div>
		</div>
